...
In order to evaluate developed models, the data is partitioned into train and test with a ratio of 80% to 20%.

# 3. Results
## Newton-Raphson 
complete separation 

comparison of using glm function and developed algorithm
## Five-fold CV for Logistic-LASSO
Comparing optimal with full model 


# 4. Discussion
Lasso-logistic model performed better than the full logistic
model.

The most ideal performance is to classify each patient
correctly, i.e. Specificity = Sensitivity = 1

Future work: Predictors need to be interpreted or have some
