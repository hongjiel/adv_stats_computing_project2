...
Hongjie Liu worked on developing the algorithms, writing the R functions and mathematical proofs, as well as writing the corresponding sections of the report. He was also responsible for delivering the presentation of task 3.



Shaohan Chen worked on function visualization, organizing the first two parts of the presentation slides and some sections of the report. Hongjie Liu was more than modest about his group contribution in the above statements, while he actually finished most of the significant parts of the project. Therefore, I would like to emphasize his extraordinary contribution, study attitude and the research ability he demonstrated during the project.

Jiajun Tao worked mainly on the presentation as well as the report of task 4, i.e. choosing the best lambda to pick predictors and comparing the models. Here I would like to give much credit to Hongjie Liu, as he finished most of the project during the spring break. I was impressed by his learning ability and mathematical skills. Furthermore, he was also willing to help other members in the group understand the content and solve any problem. I think he deserves the praise.

Xicheng Xie worked on making and amending two parts of the slides, writing some sections of the report, and doing the presentation. I must emphasize the exceptional work of my teammate, Hongjie Liu. He was more than modest in his statements about his contribution to the project. In fact, he completed most of the significant parts of the project during spring break. His dedication to the project, coupled with his exceptional mathematical skills, was commendable.

Yujia Li gave extra thought on task 1, wrapped up the intro and method part of reports. Thanks for my teammates who all constantly commited to this project and communicated effectively, especially Hongjie Liu who was in charge of most things.
