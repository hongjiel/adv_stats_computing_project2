...
\begin{algorithm}
	...
	\begin{algorithmic}[1]
	  ...
	  \Ensure $\widehat{\boldsymbol{\beta}}_{approx}$ such that $\widehat{\boldsymbol{\beta}}_{approx} \approx \arg\max_{\boldsymbol{\beta}}\; f(\boldsymbol{\beta})$
	  ...
	  \While {convergence criterion is not met}
	    ...
	    \EndWhile
	  \EndWhile
	  \State $\widehat{\boldsymbol{\beta}}_{approx}\leftarrow \boldsymbol{\beta}_i$
	\end{algorithmic}
\end{algorithm}
